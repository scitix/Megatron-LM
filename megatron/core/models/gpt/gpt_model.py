...
class GPTModel(LanguageModule):
    ...
    def _postprocess(
        ...
        effective_mtp_labels = mtp_labels if mtp_labels is not None else labels

        if mtp_in_postprocess and effective_mtp_labels is not None:
        ...
        if self.config.mtp_num_layers and effective_mtp_labels is not None:
            mtp_labels = effective_mtp_labels.clone()
